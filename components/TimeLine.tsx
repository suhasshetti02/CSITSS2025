  ...
  return (
    <div className="w-full px-4 py-12 relative ">
      ...
      <div className={`max-w-5xl mx-auto transition-all duration-700 transform ${
        ...
        <h1 className="text-4xl font-extrabold text-gray-800 text-center mb-16 flex items-center justify-center gap-3 dark:text-white">
            ...
            >
              <div className="flex items-start gap-8 ">
                ...
                <div className={`flex-1 pt-3 transition-all duration-500 transform 
                  ...
                  <p className="text-xl text-gray-700 font-medium dark:text-gray-300">{item.date}</p>
                </div>
              </div>
            </div>
          ))}
