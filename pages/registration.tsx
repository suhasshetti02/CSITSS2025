    ...
    <>
      <div className="p-4">
        <section className="mx-auto max-w-screen-xl px-4 py-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-extrabold sm:text-4xl dark:text-white">Registration</h2>
        ...
        <section className="mx-auto max-w-screen-xl px-4 py-4 sm:px-6 lg:px-8">
            ...
            <div className="overflow-x-auto">
              <table className="min-w-full divide-y divide-x text-sm border-2 border-blue-900  divide-blue-900 ">
                <thead className="divide-x divide-y divide-blue-900 ">
                  ...
                  <tr className="divide-x divide-blue-900 dark:text-gray-300">
                ...
                <tbody className="divide-y divide-blue-900 dark:text-gray-300">
                  <tr className="divide-x text-center  divide-blue-900 dark:text-gray-300 ">
                  ...
                  {/* <br /> */}
                  <tr className="divide-x text-center bg-blue-900 text-white  divide-blue-900  dark:text-gray-300">
                    <th colSpan={6}>
                ...
                {/* <tbody className="divide-y divide-gray-200"> */}
                  ...
                  <tr className="divide-x text-center  divide-blue-900 ">
                  <th className="hidden dark:text-gray-300"></th>
                    <th>Academicians</th>
                    <td>$100</td>
                    <td>$130</td>
                    <td>$135</td>
          ...
          <div>
            <strong><i className="text-red-700 dark:text-red-500" >*All the pricing details mentioned above are inclusive of 18% GST</i></strong>
          </div>
        </section>
...
<section className="mx-auto max-w-screen-xl px-4 py-4 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-bold sm:text-2xl dark:text-white">
        ...
        <section className="mx-auto max-w-screen-xl px-4 py-4 sm:px-6 lg:px-8">
          ...
          <h3 className="text-xl font-extrabold sm:text-xl dark:text-gray-200">Instructions for Registration</h3> <br />
          <ol className="list-decimal text-justify space-y-1 dark:text-gray-200">
            <li>
        ...
        <section className="mx-auto max-w-screen-xl px-4 py-4 sm:px-6 lg:px-8">
          <h3 className="text-xl font-extrabold sm:text-xl dark:text-gray-200">Important Notes</h3> <br />
          <ol className="list-decimal text-justify space-y-1 dark:text-gray-200">
            <li>
