...
function Awards() {
  return (
    <div className="bg-light-blue-100 mt-10 py-10 ">
      <aside className="mx-auto max-w-4xl rounded-lg bg-white p-4 shadow-lg sm:p-6 lg:p-8 dark:bg-gray-900">
        <div className="text-center">
          <p className="text-2xl font-bold text-blue-700 sm:text-3xl lg:text-5xl">
            Awards
          </p>
        </div>
        <p className="my-4 text-justify text-lg font-medium text-gray-700 sm:text-xl lg:text-2xl dark:text-white">
          The below awards will be conferred by CSITSS-2024:
        </p>
        <p className="my-4 text-justify text-base font-medium text-gray-600 sm:text-lg lg:text-xl dark:text-white">
        ...
        <div className="mt-6">
          <div className="mt-4 text-center">
            <a
              ...
              download
              className="text-lg font-medium text-blue-700 hover:underline sm:text-xl lg:text-2xl dark:hover:bg-blue-500 dark:hover:bg-opacity-5" 
            >
