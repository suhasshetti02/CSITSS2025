...
function Papers() {
  return (
    <div className="bg-light-blue-100 mt-10 py-10 ">
      <aside className="mx-auto max-w-4xl transform rounded-lg bg-white p-6 shadow-lg transition duration-500 ease-in-out hover:scale-105 hover:shadow-xl sm:p-8 lg:p-12 dark:bg-gray-900">
        <div className="text-center">
          <p className="animate-fade-in text-3xl font-bold text-blue-700 sm:text-5xl">
            Conference Tracks
          </p>
        </div>
        <p className="animate-fade-in my-4 text-justify text-lg font-medium text-gray-700 dark:text-gray-200 sm:text-2xl">
          Authors are invited to submit their original research work in the
          following areas (but not limited to):
        </p>
        <ul className="animate-fade-in list-none space-y-4 text-justify text-base font-medium text-gray-600 dark:text-gray-200 sm:text-xl">
          {[
            {
              title:
