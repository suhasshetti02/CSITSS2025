...
function Papers() {
  return (
    <div className="mt-10 bg-light-blue-100 py-10">
      <aside className="bg-white shadow-lg rounded-lg p-6 sm:p-8 lg:p-12 mx-auto max-w-4xl dark:bg-gray-900">
        <div className="text-center">
          <p className="text-3xl sm:text-5xl font-bold text-blue-700 ">
            Call For Papers
          </p>
        </div>
        <p className="text-justify text-lg sm:text-2xl font-medium text-gray-700 my-4 dark:text-white">
          Conference does not accept/encourage Survey/Review articles.
        </p>
        <div className="text-justify text-base sm:text-xl font-medium text-gray-600 my-4 dark:text-white">
