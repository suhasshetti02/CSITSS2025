...
function Contact() {
  return (
    <>
      <br />
      <div className="container my-8 mx-auto bg-white p-4 md:p-8 rounded-lg shadow-lg dark:bg-dark">
            ...
            <div className="md:flex md:flex-col md:justify-between">
              <div className="mb-4 p-2 md:mb-0 overflow-x-auto">
                <table className="w-full border-collapse border border-gray-300 text-sm rounded-lg shadow-sm">
                  <thead>
                    <tr className="bg-blue-200 dark:bg-blue-900 dark:text-white">
                      <th className="border border-gray-300 px-4 py-2 text-center">Name</th>
                      <th className="border border-gray-300 px-10 py-2 text-center">Contact Number</th>
                      <th className="border border-gray-300 px-10 py-2 text-center">Email</th>
                    </tr>
                  </thead>
                  <tbody>
                    <tr className="hover:bg-gray-100  dark:text-white dark:hover:bg-blue-700 dark:bg-opacity-5 dark:bg-transparent">
              ...
              <div className="mt-4">
                <h3 className="text-center text-sm md:text-lg dark:text-white">
