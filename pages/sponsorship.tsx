...
const Sponsorship: React.FC = () => {
  ...
  const sponsorGroups = Object.entries(groupedSponsors).map(
    ([type, sponsors]) => {
      ...
      return (
        <div key={type} style={{ marginBottom: '2rem' }} className='dark:bg-dark'>
          {type !== 'in association with' ? (
  ...
  return (
    <div style={{  padding: '1rem' }} className='dark:bg-dark'>
      ...
      >
        ...
        >
          <h1 style={{ fontSize: '2.5rem', fontWeight: 'bold', margin: 0 }} className='dark:text-white'>
            Sponsors of 2024
          </h1>
        </div>
        <div style={{ display: 'flex', alignItems: 'center' }} className='dark:bg-dark'>
          <h1
            style={{
              marginRight: '1rem',
              background: 'linear-gradient(to right, #ff0000, #800000)',
        ...
        >
          <a className='bg-white dark:bg-gray-900'
