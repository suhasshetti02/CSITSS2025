...
export default function Index() {
  ...
  return (
    <>
      ...
      <section className="body-font w-full m-0 text-gray-600 dark:bg-dark ">
        {/* <div className="bar">
        ...
        <header>
          ...
          >
            ...
            <div className="flex  w-full items-center justify-center  ">
              <div className="rounded-3xl backdrop-blur-sm bg-gray-800 bg-opacity-80 px-9 py-5 text-center font-extrabold mt-10">
                <h1 className="bg bg-gradient-to-r from-yellow-200  via-amber-500 via-orange-600 via-red-600 via-amber-400 to-yellow-300 bg-clip-text text-5xl font-extrabold text-transparent dark:text-white">
                ...
                <div className="flex flex-col gap-4 p-4 md:grid md:grid-cols-3">
                  <a
                    ...
                    className="mt-4 flex items-center justify-center rounded-full bg-blue-600 px-4 py-3 text-sm font-medium uppercase text-white transition-colors duration-300 ease-in-out hover:bg-blue-500 focus:bg-blue-500 focus:outline-none button "
                  
                  >
                    <span className='font-bold'>Submit Paper</span>
                    <span className="arrow text-2xl pl-3">➜</span>
                  </a>

                  <ScrollLink
                    activeClass="active"
                    className="mt-4 flex items-center justify-center rounded-full bg-blue-600 px-4 py-3 text-sm font-medium uppercase text-white transition-colors duration-300 ease-in-out hover:bg-blue-500 focus:bg-blue-500 focus:outline-none button cursor-pointer"
                    to="test4"
                    spy={true}
                    smooth={true}
                    duration={600}
        ...
        <div className="mt-4 w-full rounded-lg bg-blue-200 bg-opacity-50 py-4 px-6 text-center text-black shadow-lg dark:bg-medium">
          <p className="text-lg font-semibold dark:text-white">
            Organized by{' '}
            <span className="text-blue-700 dark:text-blue-500">RV College of Engineering</span>
            </p>
        </div>


        <div className="mt-8 grid grid-cols-2 gap-4 md:grid-cols-4 box">
        ...
        <section>
          <div className="mx-auto max-w-screen-xl px-4 py-16 sm:px-6 lg:px-8 border mt-10  about-box">
           

              <div className="animate-fadeIn2 flex flex-col justify-center " >
                <h2 className="text-gradient mb-6 text-3xl font-bold text-black sm:text-4xl dark:text-white">
                  About CSITSS
                </h2>
                <div className="mb-8 text-xl font-normal leading-relaxed text-gray-900 dark:text-white">
        ...
        <div className="mx-auto max-w-screen-xl px-4 py-16 sm:px-6 lg:px-8">
          <h1>
            <span className="text-3xl font-bold sm:text-4xl dark:text-white">
