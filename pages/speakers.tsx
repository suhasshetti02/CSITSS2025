...
const Speakers = () => {
  return (
    <div className="min-h-screen bg-white py-10 dark:bg-dark">
      ...
      <div className="mt-12 flex flex-wrap justify-center gap-8 py-6 px-4 lg:px-16 dark:bg-dark">
        {keynoteSpeakers.map((speaker) => (
          <div
            key={speaker.id}
            className="hover:border-gradient-to-r w-full max-w-xs rounded-2xl border-2 border-transparent bg-white bg-clip-border p-6 shadow-lg transition-all hover:scale hover:from-purple-500 hover:via-indigo-500 hover:to-blue-500 hover:shadow-2xl dark:bg-gray-900 "
          >
